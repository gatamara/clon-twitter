...
export default function PostCard({
  ...
  return (
    <Card className="shadow-none  hover:bg-slate-800 transition border-b rounded-none cursor-pointer border-white/20">
      ...
      <CardFooter className="gap-3">
        <button><IconMessageCircle2 className="w-4 h-4"/> </button>
